...
export function Header({ 
  ...
  return (
    <header className="sticky top-0 z-40 bg-white/70 backdrop-blur-3xl border-b border-white/50 shadow-[0_4px_30px_rgb(0,0,0,0.02)]">
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4 max-w-7xl mx-auto w-full">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 sm:w-11 sm:h-11 bg-gradient-to-br from-[#0B0F19] to-[#111827] rounded-2xl flex items-center justify-center text-white text-xl shadow-[0_10px_20px_-10px_rgba(0,0,0,0.5)] border border-slate-700/50">
            <span className="font-sans font-black tracking-tighter">Lp</span>
          </div>
          <div>
